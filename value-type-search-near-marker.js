...
module.exports = function (RED) {
    ...
    function ValueTypeSearchNearMarker(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=" + latitude + ";" + longitude + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&maxDists=" + maxDists + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
