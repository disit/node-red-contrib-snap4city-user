...
module.exports = function (RED) {
    ...
    function ServiceSearchAlongPath(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=wkt:" + path + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true&fullCount=false" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
