...
module.exports = function (RED) {
    ...
    function DashboardWebSocketListenerNode(n) {
        // Create a RED node
            ...
            socket.on('open', function () {
                if (!node.isServer) {
                    ...
                    node.tout = setTimeout(function () {
                        ...
                        startconn();
                    }, 60000); // try to reconnect every 3 secs... bit fast ?
                }
            });
    ...
    RED.nodes.registerType("dashboard-websocket-listener", DashboardWebSocketListenerNode);
    RED.nodes.registerType("dashboard-websocket-client", DashboardWebSocketListenerNode);

    DashboardWebSocketListenerNode.prototype.registerInputNode = function ( /*Node*/ handler) {
        this._inputNodes.push(handler);
    }

    DashboardWebSocketListenerNode.prototype.removeInputNode = function ( /*Node*/ handler) {
    ...
    DashboardWebSocketListenerNode.prototype.handleEvent = function (id, /*socket*/ socket, /*String*/ event, /*Object*/ data, /*Object*/ flags) {
        var msg;
        if (this.wholemsg) {
            try {
                msg = JSON.parse(data);
    ...
    DashboardWebSocketListenerNode.prototype.broadcast = function (data) {
        var i;
        try {
            if (this.isServer) {
    ...
    DashboardWebSocketListenerNode.prototype.reply = function (id, data) {
    ...
    function DashboardWebSocketInNode(n) {
        RED.nodes.createNode(this, n);
    ...
    RED.nodes.registerType("dashboard-websocket-in", DashboardWebSocketInNode);

    function DashboardWebSocketOutNode(n) {
        RED.nodes.createNode(this, n);
        var node = this;
        this.server = (n.client) ? n.client : n.server;
        this.serverConfig = RED.nodes.getNode(this.server);
    ...
    RED.nodes.registerType("dashboard-websocket-out", DashboardWebSocketOutNode);
}