...
module.exports = function (RED) {
    ...
    function ValueTypeSearchWithinPolygon(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=wkt:" + polygon + "&value_type=" + valuetype + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
