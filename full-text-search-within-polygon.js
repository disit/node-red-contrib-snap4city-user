...
module.exports = function (RED) {
    ...
    function FullTextSearchWithinPolygon(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?search=" + search + "&selection=wkt:" + polygon + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
