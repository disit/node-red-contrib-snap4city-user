...
module.exports = function (RED) {
    ...
    function ServiceSearchWithinPolygon(config) {
        ...
        node.on('input', function (msg) {
            ...
            logger.info(encodeURI(uri + "/?selection=wkt:" + polygon + "&categories=" + categories + "&maxResults=" + maxResults + "&format=json" + "&lang=" + language + "&geometry=true&fullCount=false" + (typeof uid != "undefined" && uid != "" ? "&uid=" + uid : "") + "&appID=iotapp"));
